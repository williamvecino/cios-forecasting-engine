          ...
          {data && !loading && (
            <div className="space-y-6">
              ...
              {data.decision_clarity?.targetProbability != null && (() => {
                const chatgptComparisons: Record<string, { chatgptPct: string; note: string }> = {
                  "CASE-DEMO-01": {
                    chatgptPct: "~35%",
                    note: "Unstructured AI (ChatGPT, Claude, etc.) estimates adoption probability without signal decomposition, precedent-locked likelihood ratios, or eligibility gates. CIOS enforces Bayesian discipline: each signal must cite a verifiable source, pass the precedent library, and survive dependency compression before it shifts the posterior. The difference is the gap between opinion and auditable forecast.",
                  },
                  "CASE-DEMO-02": {
                    chatgptPct: "~65%",
                    note: "ChatGPT gets the direction right but underestimates confidence — no prior governance, no precedent anchoring. CIOS enforces Bayesian discipline: each signal must cite a verifiable source, pass the precedent library, and survive dependency compression before it shifts the posterior.",
                  },
                  "CASE-DEMO-03": {
                    chatgptPct: "~44%",
                      ...
                      <div className="space-y-2 flex-1">
                        ...
                        <div className="flex items-center gap-6">
                          ...
                          <div className="text-center opacity-50">
                            <div className="text-2xl font-bold text-muted-foreground">{comp.chatgptPct}</div>

...
- **14-Case Baseline Suite (2026-04-08):** DEMO-01=12.79%, DEMO-02=21.17%, DEMO-03=25.95%, DEMO-04=34.14%, DEMO-05=11.33%, LEQEMBI-01=12.12%, LEQEMBI-02=19.49%, Beovu=36.77%, VP-REG=49.76%, VP-LAUNCH=11.20%, VP-ADOPT=4.97%, VP-COMP=34.35%, VP-BARRIER=46.60%, Veligrotug=6.69%.
- **Case Replacements:** CASE-DEMO-01 now Arikayce (prior=0.37, 5 signals), CASE-DEMO-05 now Sublocade/OUD (prior=0.35, 4 signals), CASE-1775022353034 now Beovu retrospective demo (prior=0.62, 4 signals). VP-ADOPTION-003 prior→0.25, CASE-LEQEMBI-01 prior→0.28.

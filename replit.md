...
- **Signal Precedent Library (CIOS v18):** Precedent-based signal weighting with governance controls, 10 fixed signal types across A/B/C reliability tiers with assigned LRs.

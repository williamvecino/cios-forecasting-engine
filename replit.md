...
- **Prior Templates by Case Archetype:** `prior_templates` table with 8 seeded archetypes. Each template includes default prior probability, rationale, typical positive/negative families, and common traps. Archetype selector appears on the question review page; selection flows through to case creation as `priorArchetype` and `priorRationale`.

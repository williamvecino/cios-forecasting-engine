...
export const LR_RANGES: Record<SignalType, LRRange> = {
  ...
  "Phase II clinical":           { min: 1.5, max: 2.2 },
  "Guideline / SOC":             { min: 1.3, max: 1.8 },
  "Policy / regulatory":         { min: 1.3, max: 2.0 },
  "Advocacy / patient":          { min: 1.1, max: 1.5 },
  "Competitive intelligence":    { min: 0.6, max: 0.9 },
  "Operational / manufacturing": { min: 0.6, max: 0.9 },
  "Operational constraint":      { min: 0.55, max: 0.85 },
 ...
 * Retained only for backward compatibility with validation-pack and discover routes.
 */
